...
from .forms import MembersForm, CommitteesForm, SubCommitteesForm, CSVMemberForm, CSVCommitteeForm, DataForm
from .models import Data, Members, LegislativeCSVFiles,Committees
...
def upload_member_csv(request):
    ...
    return render(request, 'upload.html', {'form': csv_form, 'csv_files': db_csv_files})
