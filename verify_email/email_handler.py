...
class _VerifyEmail:
    ...
    def __send_email(self, msg, useremail):
        ...
        print(f"Sent verification email to: {useremail}")
    ...
    def send_verification_link(self, request, form):
        ...
        try:
            ...
            print(f"Encoded token: {self.token_manager.perform_encoding(inactive_user)}")
            print(f"Decoded token: {self.token_manager.perform_decoding(self.token_manager.perform_encoding(inactive_user))}")
    ...
    def resend_verification_link(self, request, email, **kwargs):
        ...
        if encoded:
            ...
            print(f"Generated Token: {decoded_encrypted_user_token}")
